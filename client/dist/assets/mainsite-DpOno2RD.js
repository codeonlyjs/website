var j=Object.defineProperty;var C=a=>{throw TypeError(a)};var O=(a,e,t)=>e in a?j(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var o=(a,e,t)=>O(a,typeof e!="symbol"?e+"":e,t),D=(a,e,t)=>e.has(a)||C("Cannot "+t);var n=(a,e,t)=>(D(a,e,"read from private field"),t?t.call(a):e.get(a)),l=(a,e,t)=>e.has(a)?C("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(a):e.set(a,t),r=(a,e,t,i)=>(D(a,e,"write to private field"),i?i.call(a,t):e.set(a,t),t);import{C as d,H as V,$ as M,S as u,e as W,D as q,r as E,t as _,a as A,N as F,b as G,c as K}from"./HeroPage-DG5XeaMl.js";class T extends d{constructor(){super()}onMount(){}onUnmount(){}}o(T,"template",[V,M.div.class("homePage")(M.a("Read the Guide ›").href("/guide/"))]);u.declare(`
.homePage
{
    text-align: center;
    margin-bottom: 50px;
