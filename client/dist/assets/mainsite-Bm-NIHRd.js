...
`;var x,f,w,h;class J extends EventTarget{constructor(){super(...arguments);l(this,x);l(this,f);o(this,"error");l(this,w);l(this,h)}setDocUrl(t){r(this,x,t);let a=new URL("toc",t).pathname;if(a==n(this,f)){this.error||this.dispatchEvent(new Event("ready"));return}r(this,f,a),this.load()}get toc(){return n(this,w)}set toc(t){r(this,w,t),r(this,h,null)}get pages(){if(!n(this,h)&&n(this,w)){r(this,h,[]);for(let t of this.toc)n(this,h).push(...t.pages)}return n(this,h)}load(){A.load(async()=>{this.error=!1,this.toc=null,this.dispatchEvent(new Event("changed"));try{const t=await fetch(`/content${n(this,f)}`);if(!t.ok)throw new Error(`Response status: ${t.status} - ${t.statusText}`);this.toc=await t.json(),this.dispatchEvent(new Event("changed")),this.dispatchEvent(new Event("ready"))}catch(t){this.error=!0,console.error(t.message)}})}next(t){if(!this.pages)return;let a=this.pages.findIndex(s=>new URL(s.url,n(this,x)).pathname==n(this,x).pathname);return a<0||(a+=t,a<0||a>=this.pages.length)?null:this.pages[a]}}x=new WeakMap,f=new WeakMap,w=new WeakMap,h=new WeakMap;let v=new J;class U extends d{constructor(){super()}onMount(){this.listen(v,"changed",this.invalidate),this.listen(v,"ready",this.invalidate)}}o(U,"template",{type:"nav",id:"nav-main",$:[{foreach:()=>v.toc,$:[{type:"h5",text:e=>e.title},{type:"ul",$:{foreach:{items:e=>e.pages,itemKey:e=>e.url},type:"li",$:{type:"a",attr_href:e=>e.url,class_selected:e=>`/guide/${e.url=="."?"":e.url}`==window.location.pathname,text:e=>e.title}}}]}]});u`
#nav-main
{
...
`;var g,c,b,k;class L extends d{constructor(){super();l(this,g);l(this,c,null);l(this,b);l(this,k)}get structure(){return n(this,g)}set structure(t){r(this,g,t),r(this,c,null),r(this,k,null),this.invalidate(),this.positionHighlight()}hidePopupNav(){this.dispatchEvent(new Event("hidePopupNav"))}onMount(){this.listen(document,"scroll",()=>{this.positionHighlight()})}onUnmount(){}positionHighlight(){var D;if(!n(this,g))return;(!n(this,b)||n(this,b)!=document.body.scrollHeight)&&(r(this,b,document.body.scrollHeight),r(this,c,null));let t=G.get().top;n(this,c)==null&&r(this,c,n(this,g).allHeadings.map(m=>{let O=document.getElementById(m.id).getBoundingClientRect();return{id:m.id,top:O.top+t}}));let a="";if(t>20){let m=window.innerHeight||0;t+=+m/2-200;for(let y of n(this,c)){if(y.top>t)break;a=y.id}}if(a==n(this,k))return;r(this,k,a);let s=this.domTree.rootNode.querySelector(`a[href='#${a}']`);if(s){let m=this.domTree.rootNode.getBoundingClientRect(),y=s.getBoundingClientRect();this.highlight.style.top=y.top-m.top-2,this.highlight.style.height=y.height+4,(D=s.scrollIntoViewIfNeeded)==null||D.call(s,!1)}}update(){super.update(),this.positionHighlight()}}g=new WeakMap,c=new WeakMap,b=new WeakMap,k=new WeakMap,o(L,"template",{type:"nav",id:"secondary-nav",on_click:t=>t.hidePopupNav(),$:[{type:"div",class:"highlight",bind:"highlight"},{if:t=>{var a,s;return((s=(a=t.structure)==null?void 0:a.headings)==null?void 0:s.length)>0},$:{type:"a",class:"title",attr_href:"#",text:t=>t.structure.title??"On This Page"}},{type:"ul",class:"h1",$:{foreach:t=>{var a;return(a=t.structure)==null?void 0:a.headings},type:"li",$:[{type:"a",attr_href:t=>`#${t.id}`,text:t=>t.text},{if:t=>t.subHeadings,type:"ul",class:"h2",$:{foreach:t=>t.subHeadings,type:"li",$:[{type:"a",attr_href:t=>`#${t.id}`,text:t=>t.text}]}}]}}]});u`
#secondary-nav
{
    padding: 1rem;
...
`;class Y extends d{constructor(){super();o(this,"activePanel",null);this.create(),P.addEventListener("mayLeave",()=>this.hidePanel())}loadRoute(t){v.setDocUrl(t.url),this.page=t.page,this.invalidate()}showPanel(){this.activePanel="primary",this.invalidate()}showSecondaryPanel(){this.activePanel="secondary",this.invalidate()}hidePanel(){this.activePanel=null,this.invalidate()}}o(Y,"template",{type:"div#layoutDocumentation",$:[{type:I,on_showPanel:t=>t.showPanel(),on_showSecondaryPanel:t=>t.showSecondaryPanel()},{type:"div#div-wrapper",$:[{type:"div#backdrop",class_active:_(t=>t.activePanel!=null),on_click:t=>t.hidePanel()},{type:"div#div-lhs",class_active:_(t=>t.activePanel=="primary"),$:U},{type:"div#div-center",$:{type:"embed-slot",content:t=>t.page}},{type:"div#div-rhs",class_active:_(t=>t.activePanel=="secondary"),$:{type:L,structure:t=>{var a;return(a=t.page)==null?void 0:a.structure},on_hidePopupNav:t=>t.hidePanel()}}]}]});const H=720,R=250;u`
:root
{
...
`;class C extends d{constructor(e){super(),this.url=e}}o(C,"template",{type:"div",class:"center",$:[{type:"h1",class:"danger",text:"Page not found! 😟"},{type:"p",text:e=>`The page ${e.url} doesn't exist!`},{type:"p",$:{type:"a",attr_href:"/",text:"Return Home"}}]});P.register({match:i=>(i.page=new C(i.url),!0),order:1e3});const E=class E extends d{constructor(){super()}onMount(){this.listen(v,"ready",this.invalidate)}get next(){return v.next(1)}get previous(){return v.next(-1)}static link(e,t){return[{if:a=>!!a[e],type:"a",class:e,attr_href:a=>a[e].url,$:[{type:"div",class:"description muted",text:t},{type:"div",class:"title",text:a=>a[e].fullTitle}]},{else:!0,type:"div"}]}};o(E,"template",{type:"nav",class:"next-previous-navigation",$:[E.link("previous","‹ Previous"),E.link("next","Next ›")]});let z=E;u`
...
`;var $;class Z extends d{constructor(t){super();l(this,$);r(this,$,t)}get document(){return n(this,$)}set document(t){r(this,$,t),this.invalidate()}get structure(){return this.document.structure}get layout(){var t,a;switch((a=(t=this.document)==null?void 0:t.frontmatter)==null?void 0:a.layout){case"bare":return X;default:return Y}}}$=new WeakMap,o(Z,"template",[{type:N,document:t=>t.document},{type:z}]);P.register({pattern:"/:pathname*",match:async i=>{try{return i.document=new K,await i.document.load(i.match.groups.pathname),i.page=new Z(i.document),!0}catch{i.page=new C(i.url)}return!0},order:10});P.register({pattern:"/",match:i=>(i.page=new B,!0)});var p;class j extends d{constructor(){super();l(this,p,null);P.addEventListener("didEnter",(t,a)=>{var s;a.page&&(a.page.layout?(a.page.layout!=((s=n(this,p))==null?void 0:s.constructor)&&(r(this,p,new a.page.layout),this.layoutSlot.content=n(this,p)),n(this,p).loadRoute(a)):(this.layoutSlot.content=a.page,r(this,p,null)))})}}p=new WeakMap,o(j,"template",{type:"div",id:"layoutRoot",$:[{type:F,loggedIn:!0},{type:"embed-slot",bind:"layoutSlot"}]});u`
#layoutRoot
{
...
`;function Q(){new j().mount("body"),P.start()}Q();
